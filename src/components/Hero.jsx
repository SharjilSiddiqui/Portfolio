    ...
    >
      <div className="md:w-1/2 p-8 animate-fade-in-up">
        ...
        <div className="flex justify-center md:justify-start space-x-4">
          <a
            href="#projects"
            className="px-8 py-3 text-lg font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
            style={{
          ...
          <a
            href="#contact"
            className="px-8 py-3 border-2 text-lg font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
            style={{
