// This component represents a single project entry within the Projects section.
// It displays project details like title, description, technologies, and links.
const ProjectCard = ({ project, colors }) => {
  return (
    ...
    >
      <img src={project.image} alt={project.title} className="w-full h-56 object-cover object-center" />
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-2xl font-bold mb-3" style={{ color: colors.primary }}>
          {project.title}
        </h3>
        <p className="text-gray-700 text-base mb-4 flex-grow">{project.description}</p>
        ...
        <div className="flex justify-between items-center mt-auto pt-4 border-t" style={{ borderColor: colors.bgLight }}>
          <a
